...
def get_config(config_string):
    ...
    base_peg_config = dict(
        ...
        save_dir="/media/sblee/170d6766-97d9-4917-8fc6-7d6ae84df8961/SSD2/workspaces/sim_pih_fmb/fmb_dataset_builder/custom_dataset/orca_checkpoints",
        # data_path="/media/nvmep3p_2/rlds",
        data_path="/media/sblee/170d6766-97d9-4917-8fc6-7d6ae84df8961/SSD2/workspaces/sim_pih_fmb/fmb_dataset_builder/custom_dataset",
